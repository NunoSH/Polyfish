...
# Script written and developed by Nuno Sales Henriques, Tommaso Russo and Ramiro Magno #
...
#PAST OVERLAP (PO)
buf_dist_past=0.25 #buffer distance from the hauling datapoints to the deployment datapoints 
...
for(k in 1:length(vessel)){
  ...
  #classify state 3 datapoints in state 1 if min_dist > buf_dist_past from state 4 (0.25km)
  ais_st3$sts_smooth= ifelse(ais_st3$min_dist>0.25,1,3)
